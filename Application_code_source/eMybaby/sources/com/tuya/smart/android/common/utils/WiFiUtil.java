...
public class WiFiUtil {
    ...
    public static boolean disableNetwork(Context context, String str) {
        WifiManager wifiManager;
        WifiConfiguration wifiConfigBySSid = getWifiConfigBySSid(context, str);
        if (wifiConfigBySSid == null || (wifiManager = getWifiManager(context)) == null) {
            return false;
        }
        return wifiManager.disableNetwork(wifiConfigBySSid.networkId);
    }

    public static boolean enableNetwork(Context context, String str) {
        WifiManager wifiManager;
        WifiConfiguration wifiConfigBySSid = getWifiConfigBySSid(context, str);
        if (wifiConfigBySSid == null || (wifiManager = getWifiManager(context)) == null) {
            return false;
        }
        return wifiManager.enableNetwork(wifiConfigBySSid.networkId, true);
    }
    ...
    public static java.lang.String getBssid(android.content.Context r1) {
        ...
        L_0x001c:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tuya.smart.android.common.utils.WiFiUtil.getBssid(android.content.Context):java.lang.String");
    }
    ...
    public static String getIpAddress(Context context) {
        return getIpAddress((WifiManager) context.getApplicationContext().getSystemService(NetworkUtil.CONN_TYPE_WIFI));
    }
    ...
    public static boolean isWifiConnected(Context context, String str) {
        ...
        String currentSSID = getCurrentSSID(context);
        if (!TextUtils.isEmpty(currentSSID) && !TextUtils.isEmpty(str)) {
            return str.equals(currentSSID);
        }
        return false;
    }
    ...
    public static boolean removeNetwork(Context context, String str) {
        WifiManager wifiManager;
        WifiConfiguration wifiConfigBySSid = getWifiConfigBySSid(context, str);
        if (wifiConfigBySSid == null || (wifiManager = getWifiManager(context)) == null) {
            return false;
        }
        return wifiManager.removeNetwork(wifiConfigBySSid.networkId);
    }
}
