...
public class ooo000oo0 extends oo0oooo0o {
    public static final String O0000OoO = "LightHslSetUnacknowledgedAction";
    public static final int O0000Ooo = 33399;
    ...
    public ooo000oo0(int i, int i2, int i3, int i4) {
        this((Integer) null, (Integer) null, (Integer) null, i, i2, i3, i4);
    }

    public ooo000oo0(@Nullable Integer num, @Nullable Integer num2, @Nullable Integer num3, int i, int i2, int i3, int i4) {
        this.O0000o0O = num;
        this.O0000o0o = num2;
        this.O0000o = num3;
        if (i < 0 || i > 65535) {
    ...
    public byte[] O00000oO() {
        ...
        o00oo0oo00.O00000o(O0000OoO, "Saturation: " + this.O0000oOO);
        Log.v(O0000OoO, "TID: " + ((byte) this.O0000oOo));
