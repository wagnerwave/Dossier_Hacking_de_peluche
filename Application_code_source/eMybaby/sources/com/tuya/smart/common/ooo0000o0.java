...
public class ooo0000o0 extends oo0oooo0o {
    public static final String O0000OoO = "LightCtlSetAction";
    public static final int O0000Ooo = 33380;
    ...
    public ooo0000o0(int i, int i2, int i3) {
        this((Integer) null, (Integer) null, (Integer) null, i, i2, i3);
    }

    public ooo0000o0(@Nullable Integer num, @Nullable Integer num2, @Nullable Integer num3, int i, int i2, int i3) {
        this.O0000o0O = num;
        this.O0000o0o = num2;
        this.O0000o = num3;
        if (i < 800 || i > 20000) {
