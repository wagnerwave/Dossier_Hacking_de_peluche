...
public final class Arrays {
    ...
    public static class Iterator<T> implements java.util.Iterator<T> {
        ...
        public T next() {
            ...
            StringBuilder n = a.n("Out of elements: ");
    ...
    public static int compareUnsigned(byte[] bArr, byte[] bArr2) {
        ...
        for (int i = 0; i < min; i++) {
            ...
            byte b3 = bArr2[i] & AVFrame.FRM_STATE_UNKOWN;
            if (b2 < b3) {
                return -1;
            }
            if (b2 > b3) {
    ...
    public static int hashCode(Object[] objArr) {
        ...
        while (true) {
            ...
            i = (i * InputDeviceCompat.SOURCE_KEYBOARD) ^ objArr[length].hashCode();
        }
    }
    ...
    public static int hashCode(int[][] iArr) {
        int i = 0;
        for (int i2 = 0; i2 != iArr.length; i2++) {
            i = (i * InputDeviceCompat.SOURCE_KEYBOARD) + hashCode(iArr[i2]);
        }
        return i;
    }
    ...
    public static int hashCode(short[][] sArr) {
        ...
        for (int i2 = 0; i2 != sArr.length; i2++) {
            i = (i * InputDeviceCompat.SOURCE_KEYBOARD) + hashCode(sArr[i2]);
        }
        return i;
    }
