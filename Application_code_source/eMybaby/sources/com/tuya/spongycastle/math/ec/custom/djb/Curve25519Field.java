...
public class Curve25519Field {
    ...
    public static int addPExtTo(int[] iArr) {
        ...
        long j3 = ((((long) iArr[8]) & 4294967295L) - 19) + j2;
        iArr[8] = (int) j3;
        long j4 = j3 >> 32;
        if (j4 != 0) {
            j4 = (long) Nat.decAt(15, iArr, 9);
        }
        long j5 = (((long) iArr[15]) & 4294967295L) + (4294967295L & ((long) (PExt[15] + 1))) + j4;
        iArr[15] = (int) j5;
        return (int) (j5 >> 32);
    }

    public static int addPTo(int[] iArr) {
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        int i2 = iArr2[7];
        iArr2[7] = Nat.addWordTo(7, (((i2 >>> 31) - (i >>> 31)) + (Nat256.mulByWordAddTo(19, iArr, iArr2) << 1)) * 19, iArr2) + (Integer.MAX_VALUE & i2);
        if (Nat256.gte(iArr2, P)) {
            subPFrom(iArr2);
        }
    }
    ...
    public static int subPExtFrom(int[] iArr) {
        long j = (((long) iArr[0]) & 4294967295L) - (((long) PExt[0]) & 4294967295L);
        iArr[0] = (int) j;
        long j2 = j >> 32;
        if (j2 != 0) {
