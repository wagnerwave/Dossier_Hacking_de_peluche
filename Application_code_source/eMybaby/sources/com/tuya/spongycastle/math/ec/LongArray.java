...
public class LongArray implements Cloneable {
    ...
    public LongArray(BigInteger bigInteger) {
        ...
        if (bigInteger == null || bigInteger.signum() < 0) {
            ...
            if (i < i4) {
                long j = 0;
                while (i < i4) {
                    j = (j << 8) | ((long) (byteArray[i] & AVFrame.FRM_STATE_UNKOWN));
                    i++;
                }
                this.m_ints[i3] = j;
                i3--;
            ...
            while (i3 >= 0) {
                ...
                int i5 = 0;
                while (i5 < 8) {
                    j2 = (j2 << 8) | ((long) (byteArray[i] & AVFrame.FRM_STATE_UNKOWN));
                    i5++;
                    i++;
                }
                this.m_ints[i3] = j2;
    ...
    public static long addShiftedDown(long[] jArr, int i, long[] jArr2, int i2, int i3, int i4) {
        int i5 = 64 - i4;
        long j = 0;
        while (true) {
            i3--;
    ...
    public static int bitLength(long r3) {
        ...
        L_0x002e:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tuya.spongycastle.math.ec.LongArray.bitLength(long):int");
    }
    ...
    public static void distribute(long[] jArr, int i, int i2, int i3, int i4) {
        for (int i5 = 0; i5 < i4; i5++) {
            long j = jArr[i + i5];
            int i6 = i2 + i5;
            jArr[i6] = jArr[i6] ^ j;
    ...
    public static void interleave(long[] jArr, int i, long[] jArr2, int i2, int i3, int i4) {
        if (i4 == 3) {
    ...
    public static long interleave2_n(long j, int i) {
        while (i > 1) {
            i -= 2;
    ...
    public static void interleave2_n(long[] jArr, int i, long[] jArr2, int i2, int i3, int i4) {
        for (int i5 = 0; i5 < i3; i5++) {
            jArr2[i2 + i5] = interleave2_n(jArr[i + i5], i4);
        }
    }

    public static long interleave3(long j) {
    ...
    public static void interleave3(long[] jArr, int i, long[] jArr2, int i2, int i3) {
        for (int i4 = 0; i4 < i3; i4++) {
            jArr2[i2 + i4] = interleave3(jArr[i + i4]);
        }
    }

    public static long interleave3_13to65(int i) {
        int[] iArr = INTERLEAVE5_TABLE;
        return (((long) iArr[i & 127]) & 4294967295L) | ((((long) iArr[i >>> 7]) & 4294967295L) << 35);
    }

    public static long interleave3_21to63(int i) {
    ...
    public static void interleave5(long[] jArr, int i, long[] jArr2, int i2, int i3) {
        for (int i4 = 0; i4 < i3; i4++) {
            jArr2[i2 + i4] = interleave5(jArr[i + i4]);
        }
    }

    public static long interleave7(long j) {
    ...
    public static void interleave7(long[] jArr, int i, long[] jArr2, int i2, int i3) {
        for (int i4 = 0; i4 < i3; i4++) {
    ...
    public static void reduceBitWise(long[] jArr, int i, int i2, int i3, int[] iArr) {
        while (true) {
            i2--;
            if (i2 < i3) {
                return;
    ...
    public static LongArray reduceResult(long[] jArr, int i, int i2, int i3, int[] iArr) {
        return new LongArray(jArr, i, reduceInPlace(jArr, i, i2, i3, iArr));
    }

    public static void reduceVectorWise(long[] jArr, int i, int i2, int i3, int i4, int[] iArr) {
        int i5 = (i3 << 6) - i4;
        int length = iArr.length;
        while (true) {
            length--;
    ...
    public static void reduceWord(long[] jArr, int i, int i2, long j, int i3, int[] iArr) {
        int i4 = i2 - i3;
        int length = iArr.length;
        while (true) {
            length--;
    ...
    public static void reduceWordWise(long[] jArr, int i, int i2, int i3, int i4, int[] iArr) {
        int i5 = i3 >>> 6;
        int i6 = i2;
        while (true) {
            int i7 = i6 - 1;
    ...
    public static long shiftUp(long[] jArr, int i, int i2, int i3) {
        int i4 = 64 - i3;
        long j = 0;
    ...
    public static void squareInPlace(long[] jArr, int i, int i2, int[] iArr) {
        int i3 = i << 1;
        while (true) {
            i--;
            if (i >= 0) {
    ...
    public static boolean testBit(long[] jArr, int i, int i2) {
