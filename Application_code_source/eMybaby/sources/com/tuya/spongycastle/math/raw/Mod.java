...
public abstract class Mod {
    ...
    public static int getTrailingZeroes(int i) {
        int i2 = 0;
        while ((i & 1) == 0) {
            i >>>= 1;
            i2++;
        ...
        if (!Nat.isZero(length, iArr2)) {
            ...
            while (true) {
                ...
                if (copy[i3] == 0 && copy2[i3] == 0) {
                    ...
                    inversionStep = inversionStep(iArr, copy, i2, create, (Nat.subFrom(length, create2, create) - i) + inversionStep);
                    ...
                    i = inversionStep(iArr, copy2, i2, create2, (Nat.subFrom(length, create, create2) - inversionStep) + i);
