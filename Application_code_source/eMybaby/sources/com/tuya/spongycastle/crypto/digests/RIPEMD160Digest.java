...
public class RIPEMD160Digest extends GeneralDigest {
    ...
    public void processBlock() {
        ...
        int RL64 = RL(RL59, 10);
        int RL65 = RL(RL28 + f2(RL31, RL29, RL32) + this.X[7] + SHA1Digest.Y1, 7) + RL30;
        int RL66 = RL(RL29, 10);
        int RL67 = RL(RL30 + f2(RL65, RL31, RL66) + this.X[4] + SHA1Digest.Y1, 6) + RL32;
        int RL68 = RL(RL31, 10);
        int RL69 = RL(RL32 + f2(RL67, RL65, RL68) + this.X[13] + SHA1Digest.Y1, 8) + RL66;
        int RL70 = RL(RL65, 10);
        int RL71 = RL(RL66 + f2(RL69, RL67, RL70) + this.X[1] + SHA1Digest.Y1, 13) + RL68;
        int RL72 = RL(RL67, 10);
        int RL73 = RL(RL68 + f2(RL71, RL69, RL72) + this.X[10] + SHA1Digest.Y1, 11) + RL70;
        int RL74 = RL(RL69, 10);
        int RL75 = RL(RL70 + f2(RL73, RL71, RL74) + this.X[6] + SHA1Digest.Y1, 9) + RL72;
        int RL76 = RL(RL71, 10);
        int RL77 = RL(RL72 + f2(RL75, RL73, RL76) + this.X[15] + SHA1Digest.Y1, 7) + RL74;
        int RL78 = RL(RL73, 10);
        int RL79 = RL(RL74 + f2(RL77, RL75, RL78) + this.X[3] + SHA1Digest.Y1, 15) + RL76;
        int RL80 = RL(RL75, 10);
        int RL81 = RL(RL76 + f2(RL79, RL77, RL80) + this.X[12] + SHA1Digest.Y1, 7) + RL78;
        int RL82 = RL(RL77, 10);
        int RL83 = RL(RL78 + f2(RL81, RL79, RL82) + this.X[0] + SHA1Digest.Y1, 12) + RL80;
        int RL84 = RL(RL79, 10);
        int RL85 = RL(RL80 + f2(RL83, RL81, RL84) + this.X[9] + SHA1Digest.Y1, 15) + RL82;
        int RL86 = RL(RL81, 10);
        int RL87 = RL(RL82 + f2(RL85, RL83, RL86) + this.X[5] + SHA1Digest.Y1, 9) + RL84;
        int RL88 = RL(RL83, 10);
        int RL89 = RL(RL84 + f2(RL87, RL85, RL88) + this.X[2] + SHA1Digest.Y1, 11) + RL86;
        int RL90 = RL(RL85, 10);
        int RL91 = RL(RL86 + f2(RL89, RL87, RL90) + this.X[14] + SHA1Digest.Y1, 7) + RL88;
        int RL92 = RL(RL87, 10);
        int RL93 = RL(RL88 + f2(RL91, RL89, RL92) + this.X[11] + SHA1Digest.Y1, 13) + RL90;
        int RL94 = RL(RL89, 10);
        int RL95 = RL(RL90 + f2(RL93, RL91, RL94) + this.X[8] + SHA1Digest.Y1, 12) + RL92;
        int RL96 = RL(RL91, 10);
        ...
        int RL129 = RL(RL92 + f3(RL95, RL93, RL96) + this.X[3] + SHA1Digest.Y2, 11) + RL94;
        int RL130 = RL(RL93, 10);
        int RL131 = RL(RL94 + f3(RL129, RL95, RL130) + this.X[10] + SHA1Digest.Y2, 13) + RL96;
        int RL132 = RL(RL95, 10);
        int RL133 = RL(RL96 + f3(RL131, RL129, RL132) + this.X[14] + SHA1Digest.Y2, 6) + RL130;
        int RL134 = RL(RL129, 10);
        int RL135 = RL(RL130 + f3(RL133, RL131, RL134) + this.X[4] + SHA1Digest.Y2, 7) + RL132;
        int RL136 = RL(RL131, 10);
        int RL137 = RL(RL132 + f3(RL135, RL133, RL136) + this.X[9] + SHA1Digest.Y2, 14) + RL134;
        int RL138 = RL(RL133, 10);
        int RL139 = RL(RL134 + f3(RL137, RL135, RL138) + this.X[15] + SHA1Digest.Y2, 9) + RL136;
        int RL140 = RL(RL135, 10);
        int RL141 = RL(RL136 + f3(RL139, RL137, RL140) + this.X[8] + SHA1Digest.Y2, 13) + RL138;
        int RL142 = RL(RL137, 10);
        int RL143 = RL(RL138 + f3(RL141, RL139, RL142) + this.X[1] + SHA1Digest.Y2, 15) + RL140;
        int RL144 = RL(RL139, 10);
        int RL145 = RL(RL140 + f3(RL143, RL141, RL144) + this.X[2] + SHA1Digest.Y2, 14) + RL142;
        int RL146 = RL(RL141, 10);
        int RL147 = RL(RL142 + f3(RL145, RL143, RL146) + this.X[7] + SHA1Digest.Y2, 8) + RL144;
        int RL148 = RL(RL143, 10);
        int RL149 = RL(RL144 + f3(RL147, RL145, RL148) + this.X[0] + SHA1Digest.Y2, 13) + RL146;
        int RL150 = RL(RL145, 10);
        int RL151 = RL(RL146 + f3(RL149, RL147, RL150) + this.X[6] + SHA1Digest.Y2, 6) + RL148;
        int RL152 = RL(RL147, 10);
        int RL153 = RL(RL148 + f3(RL151, RL149, RL152) + this.X[13] + SHA1Digest.Y2, 5) + RL150;
        int RL154 = RL(RL149, 10);
        int RL155 = RL(RL150 + f3(RL153, RL151, RL154) + this.X[11] + SHA1Digest.Y2, 12) + RL152;
        int RL156 = RL(RL151, 10);
        int RL157 = RL(RL152 + f3(RL155, RL153, RL156) + this.X[5] + SHA1Digest.Y2, 7) + RL154;
        int RL158 = RL(RL153, 10);
        int RL159 = RL(RL154 + f3(RL157, RL155, RL158) + this.X[12] + SHA1Digest.Y2, 5) + RL156;
        ...
        int RL193 = RL(RL156 + f4(RL159, RL157, RL160) + this.X[1] + SHA1Digest.Y3, 11) + RL158;
        int RL194 = RL(RL157, 10);
        int RL195 = RL(RL158 + f4(RL193, RL159, RL194) + this.X[9] + SHA1Digest.Y3, 12) + RL160;
        int RL196 = RL(RL159, 10);
        int RL197 = RL(RL160 + f4(RL195, RL193, RL196) + this.X[11] + SHA1Digest.Y3, 14) + RL194;
        int RL198 = RL(RL193, 10);
        int RL199 = RL(RL194 + f4(RL197, RL195, RL198) + this.X[10] + SHA1Digest.Y3, 15) + RL196;
        int RL200 = RL(RL195, 10);
        int RL201 = RL(RL196 + f4(RL199, RL197, RL200) + this.X[0] + SHA1Digest.Y3, 14) + RL198;
        int RL202 = RL(RL197, 10);
        int RL203 = RL(RL198 + f4(RL201, RL199, RL202) + this.X[8] + SHA1Digest.Y3, 15) + RL200;
        int RL204 = RL(RL199, 10);
        int RL205 = RL(RL200 + f4(RL203, RL201, RL204) + this.X[12] + SHA1Digest.Y3, 9) + RL202;
        int RL206 = RL(RL201, 10);
        int RL207 = RL(RL202 + f4(RL205, RL203, RL206) + this.X[4] + SHA1Digest.Y3, 8) + RL204;
        int RL208 = RL(RL203, 10);
        int RL209 = RL(RL204 + f4(RL207, RL205, RL208) + this.X[13] + SHA1Digest.Y3, 9) + RL206;
        int RL210 = RL(RL205, 10);
        int RL211 = RL(RL206 + f4(RL209, RL207, RL210) + this.X[3] + SHA1Digest.Y3, 14) + RL208;
        int RL212 = RL(RL207, 10);
        int RL213 = RL(RL208 + f4(RL211, RL209, RL212) + this.X[7] + SHA1Digest.Y3, 5) + RL210;
        int RL214 = RL(RL209, 10);
        int RL215 = RL(RL210 + f4(RL213, RL211, RL214) + this.X[15] + SHA1Digest.Y3, 6) + RL212;
        int RL216 = RL(RL211, 10);
        int RL217 = RL(RL212 + f4(RL215, RL213, RL216) + this.X[14] + SHA1Digest.Y3, 8) + RL214;
        int RL218 = RL(RL213, 10);
        int RL219 = RL(RL214 + f4(RL217, RL215, RL218) + this.X[5] + SHA1Digest.Y3, 6) + RL216;
        int RL220 = RL(RL215, 10);
        int RL221 = RL(RL216 + f4(RL219, RL217, RL220) + this.X[6] + SHA1Digest.Y3, 5) + RL218;
        int RL222 = RL(RL217, 10);
        int RL223 = RL(RL218 + f4(RL221, RL219, RL222) + this.X[2] + SHA1Digest.Y3, 12) + RL220;
        ...
        int RL319 = RL285 + this.H1 + RL(RL314, 10);
    ...
    public void processWord(byte[] bArr, int i) {
        ...
        int i3 = i2 + 1;
        this.xOff = i3;
        iArr[i2] = ((bArr[i + 3] & AVFrame.FRM_STATE_UNKOWN) << 24) | (bArr[i] & AVFrame.FRM_STATE_UNKOWN) | ((bArr[i + 1] & AVFrame.FRM_STATE_UNKOWN) << 8) | ((bArr[i + 2] & AVFrame.FRM_STATE_UNKOWN) << Tnaf.POW_2_WIDTH);
        if (i3 == 16) {
            processBlock();
        }
    }
