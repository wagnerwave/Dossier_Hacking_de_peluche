        ...
        if (identityHashMap == null || !identityHashMap.containsKey(obj3)) {
            ...
            try {
                ...
                for (Map.Entry next : map.entrySet()) {
                    ...
                    if (jSONSerializer2.applyName(obj3, key)) {
                        if (jSONSerializer2.apply(obj3, key, value)) {
                            ...
                            if (processValue != null || (serializeWriter.features & SerializerFeature.WriteMapNullValue.mask) != 0) {
                                ...
                                if (processValue == null) {
                                    ...
                                    if (cls3 == cls2) {
                                        objectSerializer.write(jSONSerializer2, processValue, processKey, (Type) null);
                                    } else {
                                        ObjectSerializer objectSerializer2 = jSONSerializer2.config.get(cls3);
                                        objectSerializer2.write(jSONSerializer2, processValue, processKey, (Type) null);
