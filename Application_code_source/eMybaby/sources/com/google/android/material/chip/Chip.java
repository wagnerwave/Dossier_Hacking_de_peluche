...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    public class ChipTouchHelper extends ExploreByTouchHelper {
        ...
        public void onPopulateNodeForHost(@NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            accessibilityNodeInfoCompat.setClassName((Chip.this.isCheckable() || Chip.this.isClickable()) ? Chip.this.isCheckable() ? Chip.COMPOUND_BUTTON_ACCESSIBILITY_CLASS_NAME : Chip.BUTTON_ACCESSIBILITY_CLASS_NAME : "android.view.View");
    ...
    private void updateAccessibilityDelegate() {
        ViewCompat.setAccessibilityDelegate(this, (!hasCloseIcon() || !isCloseIconVisible() || this.onCloseIconClickListener == null) ? null : this.touchHelper);
    }
    ...
    private void validateAttributes(@Nullable AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            } else if (attributeSet.getAttributeIntValue("http://schemas.android.com/apk/res/android", NotificationCompat.WearableExtender.KEY_GRAVITY, 8388627) != 8388627) {
    ...
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setClassName((isCheckable() || isClickable()) ? isCheckable() ? COMPOUND_BUTTON_ACCESSIBILITY_CLASS_NAME : BUTTON_ACCESSIBILITY_CLASS_NAME : "android.view.View");
