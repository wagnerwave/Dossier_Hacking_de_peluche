...
public class FitModeEvaluators {
    public static final FitModeEvaluator HEIGHT = new FitModeEvaluator() {
    ...
    public static final FitModeEvaluator WIDTH = new FitModeEvaluator() {
        public void applyMask(RectF rectF, float f, FitModeResult fitModeResult) {
    ...
    public static FitModeEvaluator get(int i, boolean z, RectF rectF, RectF rectF2) {
        ...
        throw new IllegalArgumentException(a.h("Invalid fit mode: ", i));
    }
