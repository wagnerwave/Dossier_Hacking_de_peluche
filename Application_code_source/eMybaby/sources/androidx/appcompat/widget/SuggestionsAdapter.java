...
public class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ...
            StringBuilder o = a.o("Invalid icon resource ", iconResource, " for ");
            o.append(componentName.flattenToShortString());
            str = o.toString();
            Log.w(LOG_TAG, str);
            return null;
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        if (str == null || str.isEmpty() || oOO0O0O0.O0000oO0.equals(str)) {
            return null;
        }
        try {
    ...
    public Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i) {
        ...
        Uri.Builder fragment = new Uri.Builder().scheme(o00000oo0.O00000o0).authority(suggestAuthority).query("").fragment("");
