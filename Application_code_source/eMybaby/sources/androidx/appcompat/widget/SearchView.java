...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            StringBuilder n = a.n("SearchView.SavedState{");
            n.append(Integer.toHexString(System.identityHashCode(this)));
            n.append(" isIconified=");
            n.append(this.isIconified);
            n.append("}");
            return n.toString();
        }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            if (i < 960 || i2 < 720 || configuration.orientation != 2) {
                return i < 600 ? (i < 640 || i2 < 480) ? DrawerLayout.PEEK_DELAY : o00o0000o0.O00000Oo : o00o0000o0.O00000Oo;
            }
            return 256;
        }
    ...
    public void onActionViewExpanded() {
        if (!this.mExpandedInActionView) {
            ...
            this.mSearchSrcTextView.setImeOptions(imeOptions | ProductBean.ATTR_HONGWAI_SUB);
