...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public static final boolean IS_PRE_LOLLIPOP = (Build.VERSION.SDK_INT < 21);
    ...
    private ViewGroup createSubDecor() {
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            StringBuilder n = a.n("AppCompat does not support the current theme features: { windowActionBar: ");
            n.append(this.mHasActionBar);
            n.append(", windowActionBarOverlay: ");
            n.append(this.mOverlayActionBar);
            n.append(", android:windowIsFloating: ");
            n.append(this.mIsFloating);
            n.append(", windowActionModeOverlay: ");
            n.append(this.mOverlayActionMode);
            n.append(", windowNoTitle: ");
            n.append(this.mWindowNoTitle);
            n.append(" }");
    ...
    public static Configuration generateConfigDelta(@NonNull Configuration configuration, @Nullable Configuration configuration2) {
        ...
        if (!(configuration2 == null || configuration.diff(configuration2) == 0)) {
            ...
            int i19 = configuration.screenLayout & o00o0000o0.O00000Oo;
            int i20 = configuration2.screenLayout;
            if (i19 != (i20 & o00o0000o0.O00000Oo)) {
                configuration3.screenLayout |= i20 & o00o0000o0.O00000Oo;
            }
            ...
            int i23 = configuration.screenLayout & AVIOCTRLDEFs.IOTYPE_USER_IPCAM_AUDIOSTART;
            int i24 = configuration2.screenLayout;
            if (i23 != (i24 & AVIOCTRLDEFs.IOTYPE_USER_IPCAM_AUDIOSTART)) {
                configuration3.screenLayout |= i24 & AVIOCTRLDEFs.IOTYPE_USER_IPCAM_AUDIOSTART;
            }
