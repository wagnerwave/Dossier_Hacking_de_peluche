...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        private void resolveAnchorView(View view, CoordinatorLayout coordinatorLayout) {
            ...
            if (findViewById != null) {
                ...
                StringBuilder n = a.n("Could not find CoordinatorLayout descendant view with id ");
                n.append(coordinatorLayout.getResources().getResourceName(this.mAnchorId));
                n.append(" to anchor view ");
                n.append(view);
    ...
    private void offsetChildByInset(View view, Rect rect, int i) {
        ...
        if (ViewCompat.isLaidOut(view) && view.getWidth() > 0 && view.getHeight() > 0) {
            ...
            if (behavior == null || !behavior.getInsetDodgeRect(this, view, acquireTempRect)) {
                ...
                StringBuilder n = a.n("Rect should be within the child's bounds. Rect:");
                n.append(acquireTempRect.toShortString());
                n.append(" | Bounds:");
                n.append(acquireTempRect2.toShortString());
    ...
    public static Behavior parseBehavior(Context context, AttributeSet attributeSet, String str) {
        ...
        try {
            ...
            throw new RuntimeException(a.k("Could not inflate Behavior subclass ", str), e2);
        }
    }
            ...
            if (view instanceof AttachedBehavior) {
                ...
                if (defaultBehavior != null) {
                    try {
                        ...
                        StringBuilder n = a.n("Default behavior class ");
