...
public class ViewDragHelper {
    ...
    private int computeSettleDuration(View view, int i, int i2, int i3, int i4) {
        ...
        int computeAxisDuration = computeAxisDuration(i, clampMag, this.mCallback.getViewHorizontalDragRange(view));
        return (int) ((((float) computeAxisDuration(i2, clampMag2, this.mCallback.getViewVerticalDragRange(view))) * (f4 / f3)) + (((float) computeAxisDuration) * f5));
    }

    public static ViewDragHelper create(@NonNull ViewGroup viewGroup, float f, @NonNull Callback callback) {
        ViewDragHelper create = create(viewGroup, callback);
        create.mTouchSlop = (int) ((1.0f / f) * ((float) create.mTouchSlop));
        return create;
    }
    ...
    public void captureChildView(@NonNull View view, int i) {
        ...
        StringBuilder n = a.n("captureChildView: parameter must be a descendant of the ViewDragHelper's tracked parent view (");
        n.append(this.mParentView);
        n.append(")");
