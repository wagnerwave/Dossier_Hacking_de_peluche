...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class LayoutManager {
        ...
        private void addViewInt(View view, int i, boolean z) {
            ...
            if (childViewHolderInt.wasReturnedFromScrap() || childViewHolderInt.isScrap()) {
                ...
                if (indexOfChild == -1) {
                    ...
                    n.append(this.mRecyclerView.indexOfChild(view));
                    throw new IllegalStateException(a.e(this.mRecyclerView, n));
        ...
        public void ignoreView(@NonNull View view) {
            ...
            if (parent != recyclerView || recyclerView.indexOfChild(view) == -1) {
                throw new IllegalArgumentException(a.e(this.mRecyclerView, a.n("View should be fully attached to be ignored")));
            }
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(@androidx.annotation.NonNull android.view.View r7, int r8) {
            ...
            L_0x005e:
                ...
                r0.append(r8)
                androidx.recyclerview.widget.RecyclerView r8 = androidx.recyclerview.widget.RecyclerView.this
                java.lang.String r8 = a.a.a.a.a.e(r8, r0)
                r7.<init>(r8)
                throw r7
            L_0x008f:
                ...
                androidx.recyclerview.widget.RecyclerView r0 = androidx.recyclerview.widget.RecyclerView.this
                java.lang.String r8 = a.a.a.a.a.e(r0, r8)
                r7.<init>(r8)
                throw r7
            */
        ...
        public int convertPreLayoutPositionToPostLayout(int i) {
            ...
            o.append(RecyclerView.this.mState.getItemCount());
            throw new IndexOutOfBoundsException(a.e(RecyclerView.this, o));
        }
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i, boolean z) {
            ...
            throw new IllegalStateException(a.e(RecyclerView.this, sb));
        }
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                StringBuilder n = a.n("Scrapped or attached views may not be recycled. isScrap:");
                n.append(viewHolder.isScrap());
                n.append(" isAttached:");
                if (viewHolder.itemView.getParent() != null) {
                    z = true;
                }
                n.append(z);
                throw new IllegalArgumentException(a.e(RecyclerView.this, n));
                ...
                throw new IllegalArgumentException(a.e(RecyclerView.this, sb));
                ...
                throw new IllegalArgumentException(a.e(RecyclerView.this, a.n("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.")));
            }
        }
        ...
        public void scrapView(View view) {
            ...
            if (!childViewHolderInt.hasAnyOfTheFlags(12) && childViewHolderInt.isUpdated() && !RecyclerView.this.canReuseUpdatedViewHolder(childViewHolderInt)) {
                ...
                throw new IllegalArgumentException(a.e(RecyclerView.this, a.n("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.")));
            }
        ...
        public androidx.recyclerview.widget.RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int r17, boolean r18, long r19) {
            ...
            L_0x00b2:
                ...
                java.lang.String r1 = a.a.a.a.a.e(r2, r1)
                r0.<init>(r1)
                throw r0
            L_0x00c4:
                java.lang.IllegalArgumentException r0 = new java.lang.IllegalArgumentException
            ...
            L_0x010b:
                androidx.recyclerview.widget.RecyclerView r2 = androidx.recyclerview.widget.RecyclerView.this
                androidx.recyclerview.widget.RecyclerView$Adapter r8 = r2.mAdapter
                androidx.recyclerview.widget.RecyclerView$ViewHolder r2 = r8.createViewHolder(r2, r9)
            ...
            L_0x0126:
                ...
                androidx.recyclerview.widget.RecyclerView$RecycledViewPool r8 = r6.mRecyclerPool
                long r10 = r10 - r0
            ...
            L_0x0166:
                ...
                boolean r1 = r8.hasAnyOfTheFlags(r0)
                ...
                if (r0 == 0) goto L_0x019f
                int r0 = androidx.recyclerview.widget.RecyclerView.ItemAnimator.buildAdapterChangeFlagsForAnimations(r8)
                r0 = r0 | 4096(0x1000, float:5.74E-42)
                androidx.recyclerview.widget.RecyclerView r1 = androidx.recyclerview.widget.RecyclerView.this
                androidx.recyclerview.widget.RecyclerView$ItemAnimator r2 = r1.mItemAnimator
                androidx.recyclerview.widget.RecyclerView$State r1 = r1.mState
                java.util.List r4 = r8.getUnmodifiedPayloads()
                androidx.recyclerview.widget.RecyclerView$ItemAnimator$ItemHolderInfo r0 = r2.recordPreLayoutInformation(r1, r8, r0, r4)
                androidx.recyclerview.widget.RecyclerView r1 = androidx.recyclerview.widget.RecyclerView.this
                r1.recordAnimationInfoIfBouncedHiddenView(r8, r0)
            L_0x019f:
                androidx.recyclerview.widget.RecyclerView r0 = androidx.recyclerview.widget.RecyclerView.this
                androidx.recyclerview.widget.RecyclerView$State r0 = r0.mState
                boolean r0 = r0.isPreLayout()
                ...
                if (r0 == 0) goto L_0x01b2
                r8.mPreLayoutPosition = r3
                goto L_0x01c5
            L_0x01b2:
                boolean r0 = r8.isBound()
                if (r0 == 0) goto L_0x01c7
                boolean r0 = r8.needsUpdate()
                if (r0 != 0) goto L_0x01c7
                boolean r0 = r8.isInvalid()
        ...
        public boolean validateViewHolderForOffsetPosition(ViewHolder viewHolder) {
            ...
            if (i < 0 || i >= RecyclerView.this.mAdapter.getItemCount()) {
                ...
                sb.append(viewHolder);
                throw new IndexOutOfBoundsException(a.e(RecyclerView.this, sb));
    ...
    public static class State {
        ...
        public void assertLayoutStep(int i) {
            if ((this.mLayoutStep & i) == 0) {
                ...
                n.append(" but it is ");
                n.append(Integer.toBinaryString(this.mLayoutStep));
        ...
        public String toString() {
            ...
            n.append(this.mTargetPosition);
            n.append(", mData=");
            n.append(this.mData);
            n.append(", mItemCount=");
            n.append(this.mItemCount);
            n.append(", mIsMeasuring=");
            n.append(this.mIsMeasuring);
            n.append(", mPreviousLayoutItemCount=");
            n.append(this.mPreviousLayoutItemCount);
            ...
            n.append(this.mStructureChanged);
            n.append(", mInPreLayout=");
            n.append(this.mInPreLayout);
            n.append(", mRunSimpleAnimations=");
            n.append(this.mRunSimpleAnimations);
            n.append(", mRunPredictiveAnimations=");
            n.append(this.mRunPredictiveAnimations);
            n.append('}');
            return n.toString();
        }
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            ...
            if (!isRecyclable()) {
                ...
                n.append(this.mIsRecyclableCount);
                n.append(")");
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childViewHolderInt != viewHolder && getChangedHolderKey(childViewHolderInt) == j) {
                ...
                if (adapter == null || !adapter.hasStableIds()) {
                    ...
                    sb.append(" \n View Holder 2:");
                    sb.append(viewHolder);
                    throw new IllegalStateException(a.e(this, sb));
                }
                ...
                throw new IllegalStateException(a.e(this, sb2));
            }
        }
    ...
    public void assertInLayoutOrScroll(String str) {
        ...
        if (str == null) {
            throw new IllegalStateException(a.e(this, a.n("Cannot call this method unless RecyclerView is computing a layout or scrolling")));
        }
        throw new IllegalStateException(a.e(this, a.n(str)));
    }

    public void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            if (str == null) {
                throw new IllegalStateException(a.e(this, a.n("Cannot call this method while RecyclerView is computing a layout or scrolling")));
            }
            throw new IllegalStateException(str);
        } else if (this.mDispatchScrollCounter > 0) {
            Log.w(TAG, "Cannot call this method in a scroll callback. Scroll callbacks mightbe run during a measure & layout pass where you cannot change theRecyclerView data. Any method call that might change the structureof the RecyclerView or the adapter contents should be postponed tothe next frame.", new IllegalStateException(a.e(this, a.n(""))));
        }
    }
    ...
    public String exceptionLabel() {
        ...
        n.append(", adapter:");
        n.append(this.mAdapter);
        n.append(", layout:");
        n.append(this.mLayout);
        n.append(", context:");
        n.append(getContext());
        return n.toString();
    }
    ...
    public ViewGroup.LayoutParams generateDefaultLayoutParams() {
        ...
        throw new IllegalStateException(a.e(this, a.n("RecyclerView has no LayoutManager")));
    }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable == null || drawable == null || stateListDrawable2 == null || drawable2 == null) {
            throw new IllegalArgumentException(a.e(this, a.n("Trying to set fast scroller without both required drawables.")));
        }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (findPointerIndex < 0) {
                ...
                n.append(this.mScrollPointerId);
        ...
        if (layoutManager != this.mLayout) {
            ...
            if (layoutManager != null) {
                if (layoutManager.mRecyclerView == null) {
                    ...
                    throw new IllegalArgumentException(a.e(layoutManager.mRecyclerView, sb));
                }
            }
            this.mRecycler.updateViewCacheSize();
            requestLayout();
