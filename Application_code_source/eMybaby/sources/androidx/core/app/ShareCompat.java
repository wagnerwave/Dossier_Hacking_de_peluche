...
public final class ShareCompat {
    ...
    public static class IntentReader {
        ...
        public Uri getStream(int i) {
            ...
            if (arrayList != null) {
                ...
                obj = this.mIntent.getParcelableExtra("android.intent.extra.STREAM");
            } else {
                StringBuilder n = a.n("Stream items available: ");
                n.append(getStreamCount());
                n.append(" index requested: ");
                n.append(i);
    ...
    public static void configureMenuItem(@NonNull MenuItem menuItem, @NonNull IntentBuilder intentBuilder) {
        ...
        StringBuilder n = a.n(HISTORY_FILENAME_PREFIX);
        n.append(intentBuilder.getContext().getClass().getName());
        shareActionProvider.setShareHistoryFileName(n.toString());
