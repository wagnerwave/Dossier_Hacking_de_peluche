...
public final class LinkifyCompat {
    public static final Comparator<LinkSpec> COMPARATOR = new Comparator<LinkSpec>() {
    ...
    public static void gatherMapLinks(java.util.ArrayList<androidx.core.text.util.LinkifyCompat.LinkSpec> r5, android.text.Spannable r6) {
        /*
    ...
    public static String makeUrl(@NonNull String str, @NonNull String[] strArr, Matcher matcher, @Nullable Linkify.TransformFilter transformFilter) {
        ...
        return (z || strArr.length <= 0) ? str : a.m(new StringBuilder(), strArr[0], str);
    }
