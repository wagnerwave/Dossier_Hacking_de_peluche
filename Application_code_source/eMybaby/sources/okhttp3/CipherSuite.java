...
public final class CipherSuite {
    ...
    public static final CipherSuite TLS_PSK_WITH_3DES_EDE_CBC_SHA = of("TLS_PSK_WITH_3DES_EDE_CBC_SHA", AVFrame.MEDIA_CODEC_AUDIO_ADPCM);
    public static final CipherSuite TLS_PSK_WITH_AES_128_CBC_SHA = of("TLS_PSK_WITH_AES_128_CBC_SHA", AVFrame.MEDIA_CODEC_AUDIO_PCM);
    public static final CipherSuite TLS_PSK_WITH_AES_256_CBC_SHA = of("TLS_PSK_WITH_AES_256_CBC_SHA", AVFrame.MEDIA_CODEC_AUDIO_SPEEX);
