...
public final class ConnectionPool {
    ...
    public ConnectionPool(int i, long j, TimeUnit timeUnit) {
        ...
        if (j <= 0) {
            throw new IllegalArgumentException(a.i("keepAliveDuration <= 0: ", j));
        }
    }
    ...
    private int pruneAndGetAllocationCount(RealConnection realConnection, long j) {
        ...
        while (i < list.size()) {
            ...
            if (reference.get() != null) {
                ...
                StringBuilder n = a.n("A connection to ");
                n.append(realConnection.route().address().url());
                n.append(" was leaked. Did you forget to close a response body?");
                Platform.get().logCloseableLeak(n.toString(), ((StreamAllocation.StreamAllocationReference) reference).callStackTrace);
                list.remove(i);
