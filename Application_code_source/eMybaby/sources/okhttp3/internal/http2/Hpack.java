...
public final class Hpack {
    ...
    public static final class Reader {
        ...
        private int readByte() {
            return this.source.readByte() & AVFrame.FRM_STATE_UNKOWN;
        }
        ...
        private void readIndexedHeader(int i) {
            ...
            StringBuilder n = a.n("Header index too large ");
            n.append(i + 1);
            ...
            while (!this.source.exhausted()) {
                ...
                if (readByte == 128) {
                    ...
                    if (readInt < 0 || readInt > this.headerTableSizeSetting) {
                        StringBuilder n = a.n("Invalid dynamic table size update ");
                        n.append(this.maxDynamicTableByteCount);
                        throw new IOException(n.toString());
                    }
    ...
    public static ByteString checkLowercase(ByteString byteString) {
        ...
        while (i < size) {
            ...
            if (b2 < 65 || b2 > 90) {
                ...
                StringBuilder n = a.n("PROTOCOL_ERROR response malformed: mixed case name: ");
