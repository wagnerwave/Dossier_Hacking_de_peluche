...
public final class Util {
    ...
    public static boolean skipAll(Source source, int i, TimeUnit timeUnit) {
        ...
        try {
            ...
            int i2 = (deadlineNanoTime > RecyclerView.FOREVER_NS ? 1 : (deadlineNanoTime == RecyclerView.FOREVER_NS ? 0 : -1));
            ...
            int i3 = (deadlineNanoTime > RecyclerView.FOREVER_NS ? 1 : (deadlineNanoTime == RecyclerView.FOREVER_NS ? 0 : -1));
            ...
            int i4 = (deadlineNanoTime > RecyclerView.FOREVER_NS ? 1 : (deadlineNanoTime == RecyclerView.FOREVER_NS ? 0 : -1));
