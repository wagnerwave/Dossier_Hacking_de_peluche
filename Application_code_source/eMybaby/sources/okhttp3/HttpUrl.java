...
public final class HttpUrl {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                ...
                r1 = 1
                okhttp3.HttpUrl$Builder$ParseResult r2 = okhttp3.HttpUrl.Builder.ParseResult.SUCCESS     // Catch:{ NoSuchFieldError -> 0x000f }
                r2 = 0
                r0[r2] = r1     // Catch:{ NoSuchFieldError -> 0x000f }
            L_0x000f:
                r0 = 2
                r2 = 4
                int[] r3 = $SwitchMap$okhttp3$HttpUrl$Builder$ParseResult     // Catch:{ NoSuchFieldError -> 0x0017 }
                okhttp3.HttpUrl$Builder$ParseResult r4 = okhttp3.HttpUrl.Builder.ParseResult.INVALID_HOST     // Catch:{ NoSuchFieldError -> 0x0017 }
                r3[r2] = r0     // Catch:{ NoSuchFieldError -> 0x0017 }
            L_0x0017:
                r3 = 3
                int[] r4 = $SwitchMap$okhttp3$HttpUrl$Builder$ParseResult     // Catch:{ NoSuchFieldError -> 0x001e }
                okhttp3.HttpUrl$Builder$ParseResult r5 = okhttp3.HttpUrl.Builder.ParseResult.UNSUPPORTED_SCHEME     // Catch:{ NoSuchFieldError -> 0x001e }
                r4[r0] = r3     // Catch:{ NoSuchFieldError -> 0x001e }
            L_0x001e:
                int[] r0 = $SwitchMap$okhttp3$HttpUrl$Builder$ParseResult     // Catch:{ NoSuchFieldError -> 0x0024 }
                okhttp3.HttpUrl$Builder$ParseResult r4 = okhttp3.HttpUrl.Builder.ParseResult.MISSING_SCHEME     // Catch:{ NoSuchFieldError -> 0x0024 }
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0024 }
            L_0x0024:
                int[] r0 = $SwitchMap$okhttp3$HttpUrl$Builder$ParseResult     // Catch:{ NoSuchFieldError -> 0x002b }
                okhttp3.HttpUrl$Builder$ParseResult r1 = okhttp3.HttpUrl.Builder.ParseResult.INVALID_PORT     // Catch:{ NoSuchFieldError -> 0x002b }
                r1 = 5
                r0[r3] = r1     // Catch:{ NoSuchFieldError -> 0x002b }
            L_0x002b:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: okhttp3.HttpUrl.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public static final class Builder {
        ...
        public static String canonicalizeHost(String str, int i, int i2) {
            ...
            InetAddress decodeIpv6 = (!percentDecode.startsWith("[") || !percentDecode.endsWith("]")) ? decodeIpv6(percentDecode, 0, percentDecode.length()) : decodeIpv6(percentDecode, 1, percentDecode.length() - 1);
            if (decodeIpv6 == null) {
                return null;
            }
        ...
        public static String inet6AddressToAscii(byte[] bArr) {
            ...
            while (i < bArr.length) {
                if (i == i2) {
                    ...
                    buffer.writeHexadecimalUnsignedLong((long) (((bArr[i] & AVFrame.FRM_STATE_UNKOWN) << 8) | (bArr[i + 1] & AVFrame.FRM_STATE_UNKOWN)));
                    i += 2;
                }
            }
        ...
        public Builder encodedPath(String str) {
            if (str == null) {
                ...
                throw new IllegalArgumentException(a.k("unexpected encodedPath: ", str));
            }
        }
        ...
        public Builder host(String str) {
            if (str != null) {
                ...
                throw new IllegalArgumentException(a.k("unexpected host: ", str));
            }
        ...
        public Builder port(int i) {
            if (i <= 0 || i > 65535) {
                throw new IllegalArgumentException(a.h("unexpected port: ", i));
            }
            this.port = i;
            return this;
        }
        ...
        public Builder scheme(String str) {
            if (str != null) {
                ...
                if (!str.equalsIgnoreCase(str2)) {
                    str2 = "https";
                    if (!str.equalsIgnoreCase(str2)) {
                        throw new IllegalArgumentException(a.k("unexpected scheme: ", str));
                    }
                }
                this.scheme = str2;
                return this;
        ...
        public Builder setEncodedPathSegment(int i, String str) {
            if (str != null) {
                ...
                throw new IllegalArgumentException(a.k("unexpected path segment: ", str));
            }
            throw new NullPointerException("encodedPathSegment == null");
        }
    ...
    public static void canonicalize(Buffer buffer, String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4) {
        Buffer buffer2 = null;
        while (i < i2) {
            ...
            if (!z || !(codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13)) {
                if (codePointAt == 43 && z3) {
                    ...
                    while (!buffer2.exhausted()) {
                        byte readByte = buffer2.readByte() & AVFrame.FRM_STATE_UNKOWN;
                        buffer.writeByte(37);
    ...
    public static HttpUrl getChecked(String str) {
        ...
        throw new UnknownHostException(a.k("Invalid host: ", str));
    }
